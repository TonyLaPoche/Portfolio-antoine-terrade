          ...
          <div className='relative flex flex-col md:flex-row m-4 border-2 border-solid'>
            ...
            <div className='p-4 flex flex-col justify-between divide-y'>
              <div className='leading-5'>
                {data.description.map(speech => <p className='mb-2 text-justify'>{speech}</p>)}
              </div>
              <div className='flex justify-evenly pt-2'>
                <a href={data.link} className='text-blue-700 hover:text-blue-500 text-xl hover:underline underline-offset-1' target="_blank" rel='noreferrer'> Repos</a>
                <a href={data.demo} className='text-blue-700 hover:text-blue-500 text-xl hover:underline underline-offset-1'target="_blank" rel='noreferrer'> Démo</a>
              </div>
            </div>
