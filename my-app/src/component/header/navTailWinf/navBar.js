            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2">
                    <a
                        ...
                        target="_blank"
                    >
                        <AiFillGithub className="w-10 h-10 transition ease-in-out fill-slate-700 dark:fill-slate-300  hover:fill-slate-900 dark:hover:fill-slate-200" />
                    </a>
                    <a
                        ...
                        target="_blank"
                    >
                        <AiFillLinkedin className="w-10 h-10 mx-5 transition-colors ease delay-50  fill-blue-500 dark:fill-slate-200 hover:fill-blue-800 dark:hover:fill-sky-300" />
                    </a>
